...
// Giỏ Hàng Open and Close Function
...
function updateTotal(moneyChange) {
  ...
  if (totalAmount > 0) {
    ...
    total.innerHTML = `<br>
      <br>
      OPS! Không có gì trong giỏ hàng của bạn cả 😑<br>
        Mua sản phẩm bằng cách rê chuột vào ảnh sản phẩm trong mục Sản Phẩm và chọn
...
// Tests whether or not person is on the Sản Phẩm page
...
function initializeItem1() {
  ...
  <img src="../img/robusta.png" alt="product" />
    <div>
      <h3><span class="span-primary">Cà phê</span> Robusta</h3>
      <h4>150.000 VND</h4>
  ...
  remove1.addEventListener("click", function () {
    item1Display.innerHTML = "";
    updateTotal(-150000 * item1Counter);
    item1Counter = 0;
    Storage.removeAmount("item1");
  });
}
